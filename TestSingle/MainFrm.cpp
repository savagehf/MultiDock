...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//lee：顶层的Ribbon bar：包含了toolbar，menu，title。。。
	m_wndRibbonBar.Create(this);
	m_wndRibbonBar.LoadFromResource(IDR_RIBBON);//lee：加载Ribbon资源(icon)
	...
	CCalendarBar& calendar, int nInitialWidth)
{
	...
	//m_dlgTest.Create(CAboutDlg::IDD, &bar);
